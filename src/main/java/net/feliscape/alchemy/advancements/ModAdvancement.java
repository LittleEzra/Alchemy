package net.feliscape.alchemy.advancements;
...
public class ModAdvancement {
    ...
    static final ResourceLocation BACKGROUND = Alchemy.asResource("textures/gui/advancements.png");
    static final String LANG = "advancement." + Alchemy.MOD_ID + ".";
    ...
    public boolean isAlreadyAwardedTo(Player player) {
        ...
        Advancement advancement = sp.getServer()
                .getAdvancements()
                .getAdvancement(Alchemy.asResource(id));
        if (advancement == null)
            return true;
    ...
    public void save(Consumer<Advancement> t) {
        ...
        datagenResult = builder.save(t, Alchemy.asResource(subfolder.isEmpty() ? id : subfolder + "/" + id)
                .toString());
    }
