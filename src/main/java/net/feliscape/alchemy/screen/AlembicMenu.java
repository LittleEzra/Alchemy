...
import net.feliscape.alchemy.block.entity.AlembicBlockEntity;
...
public class AlembicMenu extends AbstractContainerMenu {
    ...
    public AlembicMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data){
        super(ModMenuTypes.ALEMBIC_MENU.get(), pContainerId);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 48, 13)); // Input Slot
            this.addSlot(new AlembicFuelSlot(this, iItemHandler, 1, 48, 53)); // Fuel Slot
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 108, 53){
                @Override
    ...
    public int getAmount(Element element) {
        return this.data.get(element.ordinal() + 4);
    }
