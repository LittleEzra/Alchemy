package net.feliscape.alchemy.worldgen.tree.custom;
...
public class AspenFoliagePlacer extends FoliagePlacer {
    public static final Codec<AspenFoliagePlacer> CODEC = RecordCodecBuilder.create(aspenFoliagePlacerInstance
